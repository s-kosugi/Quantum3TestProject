...
namespace Quantum {
  ...
  [StructLayout(LayoutKind.Explicit)]
  public unsafe partial struct AsteroidShip : Quantum.IComponent {
  ...
  [StructLayout(LayoutKind.Explicit)]
  public unsafe partial struct AsteroidsGameRule : Quantum.IComponentSingleton {
    public const Int32 SIZE = 24;
    public const Int32 ALIGNMENT = 8;
    [FieldOffset(8)]
  ...
  public unsafe partial interface ISignalOnCollisionProjectileHitShip : ISignal {
    void OnCollisionProjectileHitShip(Frame f, CollisionInfo2D info, AsteroidsProjectile* projectile, AsteroidShip* ship);
  }
  ...
  public unsafe partial interface ISignalOnCollisionAsteroidHitShip : ISignal {
    void OnCollisionAsteroidHitShip(Frame f, CollisionInfo2D info, AsteroidShip* ship, AsteroidsAsteroid* asteroid);
  }
  ...
  public unsafe partial interface ISignalAsteroidSpawnShip : ISignal {
    void AsteroidSpawnShip(Frame f, EntityRef owner);
  }
  public unsafe partial interface ISignalEndGame : ISignal {
    void EndGame(Frame f);
  }
  public unsafe partial interface ISignalStartGameRuleInitialize : ISignal {
    void StartGameRuleInitialize(Frame f);
  }
  ...
  public unsafe partial class Frame {
    ...
    private ISignalAsteroidSpawnShip[] _ISignalAsteroidSpawnShipSystems;
    private ISignalEndGame[] _ISignalEndGameSystems;
    private ISignalStartGameRuleInitialize[] _ISignalStartGameRuleInitializeSystems;
    ...
    partial void InitGen() {
      ...
      _ISignalAsteroidSpawnShipSystems = BuildSignalsArray<ISignalAsteroidSpawnShip>();
      _ISignalEndGameSystems = BuildSignalsArray<ISignalEndGame>();
      _ISignalStartGameRuleInitializeSystems = BuildSignalsArray<ISignalStartGameRuleInitialize>();
      _ComponentSignalsOnAdded = new ComponentReactiveCallbackInvoker[ComponentTypeId.Type.Length];
      _ComponentSignalsOnRemoved = new ComponentReactiveCallbackInvoker[ComponentTypeId.Type.Length];
      BuildSignalsArrayOnComponentAdded<Quantum.AsteroidShip>();
      BuildSignalsArrayOnComponentRemoved<Quantum.AsteroidShip>();
      BuildSignalsArrayOnComponentAdded<Quantum.AsteroidsAsteroid>();
      BuildSignalsArrayOnComponentRemoved<Quantum.AsteroidsAsteroid>();
      BuildSignalsArrayOnComponentAdded<Quantum.AsteroidsGameRule>();
      BuildSignalsArrayOnComponentRemoved<Quantum.AsteroidsGameRule>();
    ...
    public unsafe partial struct FrameSignals {
      ...
      public void OnCollisionProjectileHitShip(CollisionInfo2D info, AsteroidsProjectile* projectile, AsteroidShip* ship) {
      ...
      public void OnCollisionAsteroidHitShip(CollisionInfo2D info, AsteroidShip* ship, AsteroidsAsteroid* asteroid) {
      ...
      public void AsteroidSpawnShip(EntityRef owner) {
        var array = _f._ISignalAsteroidSpawnShipSystems;
        for (Int32 i = 0; i < array.Length; ++i) {
          var s = array[i];
          if (_f.SystemIsEnabledInHierarchy((SystemBase)s)) {
            s.AsteroidSpawnShip(_f, owner);
          }
        }
      }
      public void EndGame() {
        var array = _f._ISignalEndGameSystems;
        for (Int32 i = 0; i < array.Length; ++i) {
          var s = array[i];
          if (_f.SystemIsEnabledInHierarchy((SystemBase)s)) {
            s.EndGame(_f);
      ...
      public void StartGameRuleInitialize() {
        var array = _f._ISignalStartGameRuleInitializeSystems;
        for (Int32 i = 0; i < array.Length; ++i) {
          var s = array[i];
          if (_f.SystemIsEnabledInHierarchy((SystemBase)s)) {
            s.StartGameRuleInitialize(_f);
          }
        }
      }
    }
  ...
  public unsafe partial class Statics {
    ...
    static partial void RegisterSimulationTypesGen(TypeRegistry typeRegistry) {
      ...
      typeRegistry.Register(typeof(Quantum.AsteroidShip), Quantum.AsteroidShip.SIZE);
      typeRegistry.Register(typeof(Quantum.AsteroidsAsteroid), Quantum.AsteroidsAsteroid.SIZE);
      typeRegistry.Register(typeof(Quantum.AsteroidsGameRule), Quantum.AsteroidsGameRule.SIZE);
    ...
    static partial void InitComponentTypeIdGen() {
      ComponentTypeId.Reset(ComponentTypeId.BuiltInComponentCount + 6)
        ...
        .Add<Quantum.AsteroidShip>(Quantum.AsteroidShip.Serialize, null, null, ComponentFlags.None)
        .Add<Quantum.AsteroidsAsteroid>(Quantum.AsteroidsAsteroid.Serialize, null, null, ComponentFlags.None)
        .Add<Quantum.AsteroidsGameRule>(Quantum.AsteroidsGameRule.Serialize, null, null, ComponentFlags.Singleton)
